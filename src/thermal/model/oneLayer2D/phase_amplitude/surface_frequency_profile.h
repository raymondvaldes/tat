...
#ifndef __tat_thermal_model_oneLayer2D_phase_amplitude_surface_frequency_profile__
#define __tat_thermal_model_oneLayer2D_phase_amplitude_surface_frequency_profile__
...
#endif /* defined(__tat__surface_frequency_profile__) */
