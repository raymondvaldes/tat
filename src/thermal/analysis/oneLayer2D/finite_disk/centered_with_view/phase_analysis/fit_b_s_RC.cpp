...
//  auto const RC_initial_value = optics_initial.filter_constant;
...
//    optics_updated.filter_constant = RC_time_constant;
//    
//    auto const updated_elements =
//    make_tuple( slab_updated, optics_updated ) ;
//    
