...
inline double dmax1(double a,double b) noexcept
{
if( a >= b )
  return(a);
else
...
inline double dmin1(double a,double b) noexcept
{
if( a <= b )
  return(a);
else
...
inline int min0(int a,int b) noexcept
{
if( a <= b )
  return(a);
else
...
inline int mod(int k,int m ) noexcept
{
return( k % m );
}

inline void pmat(int m,int n,double y[] ) noexcept
{
int i, j, k;
...
inline double enorm(int n,double x[]) noexcept
{
/*
*     **********
*
...
inline void qrsolv( const int n,  double r[], const int ldr, const int ipvt[],
...
inline void lmpar( const int n, double *r, const int ldr, const int *ipvt,
...
inline void qrfac( const int m, const int n, double *a, int /*lda*/, const bool pivot,
...
inline void fdjac2(void (*fcn)(int, int, double *, double *, int *,double **),
...
inline void fdjac2(std::function<void( double*, double* )> fcn,
...
////////////////////////////////////////////////////////////////////////////////
fdjac2(fcn, m, n, x, fvec, variables, fjac, ldfjac, &iflag, epsfcn, wa4);
////////////////////////////////////////////////////////////////////////////////
...
*/
iflag = 1;
fcn(m,n,wa2,wa4,&iflag,variables);
