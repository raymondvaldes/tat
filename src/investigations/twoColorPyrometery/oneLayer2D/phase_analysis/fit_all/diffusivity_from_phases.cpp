...
using thermal::analysis::oneLayer2D::estimate_parameters::phase_analysis::fit_all::diffusivity_from_phases;
...
//    0.491 * radians
  ...
  auto const bestFit_results = thermal::analysis::oneLayer2D::estimate_parameters::phase_analysis::fit_all::diffusivity_from_phases(
