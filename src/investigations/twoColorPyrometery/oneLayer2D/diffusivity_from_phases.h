...
#ifndef __tat_investigations_twoColorPyrometery_oneLayer2D_diffusivity_from_phases__
#define __tat_investigations_twoColorPyrometery_oneLayer2D_diffusivity_from_phases__
